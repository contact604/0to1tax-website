...
## 🎯 **v1.5.0 업데이트 (2026-01-12)**

### ✨ **NEW: 히어로 전용 첫 페이지**
- [x] **첫 페이지 히어로만 표시**: 페이지 로드 시 히어로만 보이고 스크롤 불가
- [x] **히어로 높이 고정**: `height: calc(100vh - 60px)` (헤더 제외)
- [x] **body 스크롤 제어**: `overflow: hidden` 설정
- [x] **"같이 성장하기" 버튼**: About 섹션으로 부드럽게 전환
- [x] **Final Info 섹션 완전 숨김**: `top: -100%`, `display: none`, `!important` 적용
...
9. ✅ FAQ 아코디언 (7개 질문)
10. ✅ 푸터 정보 (회사 상세 정보)
11. ✅ **로켓 파비콘 추가** (`rocket-icon.svg`) 🚀
12. ✅ **Savetax 브랜드 정보 추가** (FAQ 및 JSON-LD) 🏢
13. ✅ **모바일 Problem 섹션 스크롤 개선** 📱
